...
class OnboardingViewController: InstructionViewController {
    ...
    init(id: Int, indicatorText: String, title: String, instructions: String, image: Gif?, caption: String? = nil, buttonTitle: String, selectionDelegate: TargetSelector? = nil, additionalViews: [UIView]) {
